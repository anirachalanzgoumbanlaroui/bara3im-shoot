...
urlpatterns = [
    ...
    path('employee/<uuid:employee_id>/excel/', views.EmployeeExcelExportView.as_view(), name='export_employee_excel'),
    path('employees/excel/', views.AllEmployeesExcelExportView.as_view(), name='export_all_employees_excel'),
    path('daily/<uuid:workday_id>/excel/', views.DailyWorkDayExcelExportView.as_view(), name='export_daily_id_excel'),
